...
class JCWAutoTest0015(JcwCase, unittest.TestCase):
    '''
        Automated test case 
    ...
    def custom_setUp(self):
        ...
        if accountMainPage.checkupTableData(
                {'accountUsername': self.data.get('create_userData').get('accountUsername')}):
            pass
        else:
